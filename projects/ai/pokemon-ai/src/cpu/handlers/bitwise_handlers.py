...
def and_a_b(self, opcode_info) -> int:
    """AND A, B - Bitwise AND of A and B, result in A"""
    a_val = self.get_register("A")
    b_val = self.get_register("B")
    result = a_val & b_val
...
def and_a_c(self, opcode_info) -> int:
    """AND A, C - Bitwise AND of A and C, result in A"""
    a_val = self.get_register("A")
    c_val = self.get_register("C")
    result = a_val & c_val
...
def and_a_d(self, opcode_info) -> int:
    """AND A, D - Bitwise AND of A and D, result in A"""
    a_val = self.get_register("A")
    d_val = self.get_register("D")
    result = a_val & d_val
...
def and_a_e(self, opcode_info) -> int:
    """AND A, E - Bitwise AND of A and E, result in A"""
    a_val = self.get_register("A")
    e_val = self.get_register("E")
    result = a_val & e_val
...
def and_a_h(self, opcode_info) -> int:
    """AND A, H - Bitwise AND of A and H, result in A"""
    a_val = self.get_register("A")
    h_val = self.get_register("H")
    result = a_val & h_val
...
def and_a_l(self, opcode_info) -> int:
    """AND A, L - Bitwise AND of A and L, result in A"""
    a_val = self.get_register("A")
    l_val = self.get_register("L")
    result = a_val & l_val
...
def and_a_hl(self, opcode_info) -> int:
    """AND A, (HL) - Bitwise AND of A and memory at HL, result in A"""
    a_val = self.get_register("A")
    hl_addr = self.get_register("HL")
    mem_val = self.memory.get_value(hl_addr)
...
def and_a_a(self, opcode_info) -> int:
...
def and_a_n8(self, opcode_info) -> int:
    """AND A, n8 - Bitwise AND of A and immediate 8-bit value, result in A"""
    a_val = self.get_register("A")
    n8_val = self.operand_values[1]["value"]
    result = a_val & n8_val
...
def or_a_b(self, opcode_info) -> int:
...
def or_a_c(self, opcode_info) -> int:
...
def or_a_d(self, opcode_info) -> int:
...
def or_a_e(self, opcode_info) -> int:
...
def or_a_h(self, opcode_info) -> int:
...
def or_a_l(self, opcode_info) -> int:
...
def or_a_hl(self, opcode_info) -> int:
...
def or_a_a(self, opcode_info) -> int:
...
def or_a_n8(self, opcode_info) -> int:
...
def xor_a_b(self, opcode_info) -> int:
...
def xor_a_c(self, opcode_info) -> int:
...
def xor_a_d(self, opcode_info) -> int:
...
def xor_a_e(self, opcode_info) -> int:
...
def xor_a_h(self, opcode_info) -> int:
...
def xor_a_l(self, opcode_info) -> int:
...
def xor_a_hl(self, opcode_info) -> int:
...
def xor_a_a(self, opcode_info) -> int:
...
def xor_a_n8(self, opcode_info) -> int:
...
def cp_a_b(self, opcode_info) -> int:
    ...
    self.set_flag("H", half_borrow)
    self.set_flag("C", result < 0)  # Borrow occurred if result is negative

    return opcode_info["cycles"][0]


def cp_a_c(self, opcode_info) -> int:
...
def cp_a_d(self, opcode_info) -> int:
...
def cp_a_e(self, opcode_info) -> int:
...
def cp_a_h(self, opcode_info) -> int:
...
def cp_a_l(self, opcode_info) -> int:
...
def cp_a_hl(self, opcode_info) -> int:
...
def cp_a_a(self, opcode_info) -> int:
...
def cp_a_n8(self, opcode_info) -> int:
